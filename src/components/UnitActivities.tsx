...
export default function UnitActivities({ 
  ...
  // Unscramble Game (Unit 5, Activity 3)
  const unscrambleSentences = [
    { id: "s1", words: ["in", "this", "What's", "English?"], correct: "What's this in English?", ar: "" },
    { id: "s2", words: ["box.", "a", "It's"], correct: "It's a box.", ar: "" },
    { id: "s3", words: ["a", "Is", "van?", "that"], correct: "Is that a van?", ar: "" },
    { id: "s4", words: ["a", "it's", "car.", "No,"], correct: "No, it's a car.", ar: "" }
  ];
  ...
  const resetActivityStates = () => {
    ...
    setUnscrambledAnswers({ s1: [], s2: [], s3: [], s4: [] });
  };
      ...
      <div className="bg-amber-50 rounded-[28px] p-2 border border-amber-100 flex flex-col gap-2 shadow-xs">
        <div className="flex justify-between items-center px-3 pt-1">
          ...
          <span className="text-[10px] font-black bg-amber-200/60 text-amber-900 px-2.5 py-0.5 rounded-full">
            Page {41 + (unitId - 1) * 8 + activeActivity}
          </span>
        </div>
        ...
        <div className="border-b border-slate-100 pb-3 flex justify-between items-start">
          <div>
            ...
            <h4 className="text-md sm:text-lg font-black text-indigo-950 uppercase leading-snug">
              {/* Unit-specific Title Map */}
              {unitId === 1 && activeActivity === 0 && "Activity 1 (Lesson 1): Trace the Lines"}
              {unitId === 1 && activeActivity === 1 && "Activity 2 (Lesson 2): Write numbers 1 to 10"}
              {unitId === 1 && activeActivity === 2 && "Activity 3 (Lesson 3): Write letters A and a"}
              {unitId === 1 && activeActivity === 3 && "Activity 4 (Lesson 4): Write letters B and b"}
              {unitId === 1 && activeActivity === 4 && "Activity 5 (Lesson 5): Write letters C & D"}
              {unitId === 1 && activeActivity === 5 && "Activity 6 (Lesson 6): Alphabet Letters Review"}
              {unitId === 1 && activeActivity === 6 && "Activity 7 (Lesson 7): Interactive Matching Game"}
              {unitId === 1 && activeActivity === 7 && "Activity 8 (Lesson 8): Match the Word with the Image"}

              {unitId === 2 && activeActivity === 0 && "Activity 1 (Lesson 1): Write E and e"}
              {unitId === 2 && activeActivity === 1 && "Activity 2 (Lesson 2): Match the Word with the Image"}
              {unitId === 2 && activeActivity === 2 && "Activity 3 (Lesson 3): Write F and f"}
              {unitId === 2 && activeActivity === 3 && "Activity 4 (Lesson 4): Say, Spell and Write"}
              {unitId === 2 && activeActivity === 4 && "Activity 5 (Lesson 5): Write G and g"}
              {unitId === 2 && activeActivity === 5 && "Activity 6 (Lesson 6): Match the Word with the Image"}
              {unitId === 2 && activeActivity === 6 && "Activity 7 (Lesson 7): Write H and h"}
              {unitId === 2 && activeActivity === 7 && "Activity 8 (Lesson 8): Word Spelling challenge"}

              {unitId === 3 && activeActivity === 0 && "Activity 1 (Lesson 1): Write L and l"}
              {unitId === 3 && activeActivity === 1 && "Activity 2 (Lesson 2): Match the Word with the Image"}
              {unitId === 3 && activeActivity === 2 && "Activity 3 (Lesson 3): Write M and m"}
              {unitId === 3 && activeActivity === 3 && "Activity 4 (Lesson 4): Colours Spelling"}
              {unitId === 3 && activeActivity === 4 && "Activity 5 (Lesson 5): Paint Sudanese Flag"}
              {unitId === 3 && activeActivity === 5 && "Activity 6 (Lesson 6): Write N and n"}
              {unitId === 3 && activeActivity === 6 && "Activity 7 (Lesson 7): Traffic Lights"}
              {unitId === 3 && activeActivity === 7 && "Activity 8 (Lesson 8): Hair and Clothes Match"}

              {unitId === 4 && activeActivity === 0 && "Activity 1 (Lesson 1): Write S and s"}
              {unitId === 4 && activeActivity === 1 && "Activity 2 (Lesson 2): Match the Word with the Image"}
              {unitId === 4 && activeActivity === 2 && "Activity 3 (Lesson 3): Write T & U"}
              {unitId === 4 && activeActivity === 3 && "Activity 4 (Lesson 4): Body Parts Labeling"}
              {unitId === 4 && activeActivity === 4 && "Activity 5 (Lesson 5): Write V and v"}
              {unitId === 4 && activeActivity === 5 && "Activity 6 (Lesson 6): Counting Body Parts"}
              {unitId === 4 && activeActivity === 7 && "Activity 8 (Lesson 8): Fun Animals Match"}

              {unitId === 5 && activeActivity === 0 && "Activity 1 (Lesson 1): Write and Join Letters"}
              {unitId === 5 && activeActivity === 1 && "Activity 2 (Lesson 2): Match the Word with the Image"}
              {unitId === 5 && activeActivity === 2 && "Activity 3 (Lesson 3): Sentence Unscramble"}
              {unitId === 5 && activeActivity === 3 && "Activity 4 (Lesson 4): Write X and x"}
              {unitId === 5 && activeActivity === 4 && "Activity 5 (Lesson 5): Classroom Hunt"}
              {unitId === 5 && activeActivity === 5 && "Activity 6 (Lesson 6): Write Y and Y"}
              {unitId === 5 && activeActivity === 7 && "Activity 8 (Lesson 8): Write Z and z"}
            </h4>
            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
              ...
              <span className="text-[10px] font-black bg-indigo-50 text-indigo-855 px-2.5 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1">
                <span>📖 Workbook Page {41 + (unitId - 1) * 8 + activeActivity}</span>
              </span>
            </div>
          </div>
          <button
