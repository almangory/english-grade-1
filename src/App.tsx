...
export default function App() {
  ...
  const [bookSection, setBookSection] = useState<"lessons" | "activities">("lessons");
      ...
      <header className="max-w-6xl w-full mx-auto mb-6 flex flex-col md:flex-row justify-between items-center gap-4 relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sky-600 font-bold text-sm sm:text-lg">Grade 1 Primary • Grade 1 Starter 1 Companion</p>
          </div>
        </div>
              ...
              {activeTab === "book" && (
                ...
                >
                  ...
                  <div className="flex justify-center w-full no-print">
                    <div className="flex bg-slate-100 p-1.5 rounded-[24px] w-full max-w-md shadow-xs border border-slate-200/50">
                      <button
                        onClick={() => setBookSection("lessons")}
                        className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-[18px] text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${
                          bookSection === "lessons"
                  ...
                  {quizIsConfiguring ? (
                    <div className="bg-white p-6 sm:p-8 rounded-[36px] border-b-8 border-r-8 border-slate-200/90 shadow-sm flex flex-col gap-6 max-w-2xl mx-auto w-full">
                      <div className="border-b border-slate-100 pb-4 text-center">
                        ...
                        <p className="text-xs font-bold text-slate-500 mt-1">Practice and challenge yourself on Grade 1 English syllabus!</p>
                      </div>
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-indigo-600 to-sky-600 text-white p-6 rounded-[32px] border-b-6 border-r-6 border-indigo-900/80 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-indigo-100 font-bold mt-1">
                        Generate interactive practice sheets and clean, print-ready A4 worksheets matching the Grade 1 SMILE English curriculum.
                      </p>
                    </div>
